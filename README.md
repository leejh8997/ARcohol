...
<h4>구현 기능</h4>
<ul>    
<li>포트원 결제, 최근 본 상품, 주문 상태별 분기 처리, 주요 컬러 스킴화, AI학습용 자료 수집, 리뷰 작성 및 수정, 상품 목록 순차 로딩</li>
</ul>
...
<h4>작업 페이지</h4>
<ul>  
<li>레시피 크롤링 및 DB 초기화, 레시피, 마이 바</li>
</ul>
...
<ul>
<li>처음으로 팀장을 맡아 전체 일정과 역할을 조율하며 프로젝트를 이끄는 과정에서 개발 외적인 책임감과 소통의 중요성을 깊이 체감했습니다.
<li>다양한 상태 관리와 조건부 렌더링 구현을 통해 복잡한 UI 흐름을 구조적으로 분리하고 유지보수성을 고려하는 습관을 익혔습니다.
<li>Firebase 기반의 NoSQL 설계와 Firestore 비동기 흐름을 직접 다루며 데이터 구조화와 효율적인 쿼리 설계에 대한 이해를 높였습니다.
</ul>
</div>
